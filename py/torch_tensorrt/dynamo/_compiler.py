...
def cross_compile_for_windows(
    ...
    *,
    ...
    disabled_constant_fold_exclusions: Optional[Collection[str]] = None,
    ...
    **kwargs: Any,
    ...
    Keyword Arguments:
        ...
        disabled_constant_fold_exclusions (Optional[Collection[str]]): IDs of
            ...
            ``"attention_mask_arange"``. Default is None.
    ...
    compilation_options = {
        ...
        "disabled_constant_fold_exclusions": (
            disabled_constant_fold_exclusions
            if disabled_constant_fold_exclusions is not None
            else set()
        ),
